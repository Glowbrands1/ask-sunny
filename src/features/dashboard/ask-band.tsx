...
import { DEMO_ANCHOR, demoNow, formatLongDate, greetingForHour, nowIso } from "@/lib/utils/date";
...
export function AskBand({
  ...
  const { primaryLocationName, managerDisplayName, user, brand } = useSession();
  ...
  const greetingName = user.isSalonAccount ? primaryLocationName : managerDisplayName;
