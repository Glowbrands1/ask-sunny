/**
 * ============================================================================
 * THE SEEDED GOOGLE REVIEWS SCREEN — kept, and now only reachable when Supabase
 * is not configured at all.
 * ============================================================================
 *
 * The live screen is `reviews-screen.tsx`, which reads persisted Google reviews
 * from Supabase and is what every configured deployment renders. This file is
 * the prototype it replaced.
 *
 * IT IS KEPT RATHER THAN DELETED FOR ONE REASON: a deployment with no Supabase
 * credentials has nothing to show, and a blank page is a worse answer than
 * clearly-labelled seeded content with the `DemoDataNote` under it. It is never
 * rendered beside real data — the page picks one or the other — so no figure on
 * a real dashboard can be an invented one.
 *
 * NOTHING HERE FEEDS THE LIVE SCREEN. No import crosses between them.
 */
...
export function ReviewsDemoScreen() {
